...
@section('content')
    <section class="bg-[var(--color-surface)] py-16 lg:py-24 border-b border-[var(--color-border-subtle)]">
        <div class="mx-auto max-w-4xl px-4 text-center">
            <h1 class="text-3xl font-bold tracking-tight text-[var(--color-text-main)] sm:text-4xl">
                Cookie Policy – {{ config('company.brand') }}
            </h1>
    ...
    <section class="py-16 lg:py-24 bg-white">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 prose prose-lg prose-slate text-[var(--color-text-muted)]">
            ...
            <h3>2. Legal Basis for Cookie Usage (GDPR & ePrivacy Directive)</h3>
            <p>
            ...
            <h4>3.4 Advertising and Marketing Cookies</h4>
            <p>
            ...
            <h3>5. Cookie Consent Management</h3>
            <p>
            ...
            <h3>6. How Users Can Control Cookies</h3>
            <p>
            ...
            <h3>7. Cookie Retention Period</h3>
            <p>
            ...
            <h3>11. Updates to This Cookie Policy</h3>
            <p>
