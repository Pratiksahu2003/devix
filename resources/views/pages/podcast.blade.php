...
@section('content')
    @php
        ...
        $galleryItems = [
            ['src' => $pageImages[1], 'alt' => 'Studio Ambiance'],
            ['src' => $pageImages[2], 'alt' => 'Creative Lighting'],
            ['src' => $pageImages[3], 'alt' => 'Podcast Setup'],
            ['src' => $pageImages[4], 'alt' => 'Cozy Corner'],
            ['src' => $pageImages[5], 'alt' => 'Lounge Area'],
            ['src' => $pageImages[6], 'alt' => 'Acoustic Treatment'],
        ];
    @endphp
    ...
    {{-- Hero Section --}}
    <div class="relative bg-slate-950 h-[65vh] min-h-[420px] overflow-hidden group">
        ...
        <div class="relative h-full mx-auto max-w-7xl px-4 sm:px-6 flex flex-col justify-center items-center text-center">
            <div class="max-w-4xl">
                <span class="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 px-5 py-2 text-xs font-semibold text-white/90 backdrop-blur-xl mb-5 tracking-widest uppercase">
                ...
                <p class="mt-4 max-w-2xl text-base sm:text-lg text-slate-300 leading-relaxed mx-auto font-light">
                    Professional Podcast Recording Studio – {{ config('company.brand') }}
                </p>
            </div>
            <div class="mt-6 flex flex-col sm:flex-row gap-3">
                <a href="{{ route('pages.contact') }}" class="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 text-base font-bold text-slate-900 transition-all duration-300 hover:bg-slate-100 hover:scale-[1.02] active:scale-[0.98] shadow-2xl shadow-black/30">
                    Book Podcast Studio
            ...
            <div class="mt-8 flex gap-8 text-center text-white/70 text-sm">
    ...
    <section class="bg-[var(--color-surface)] py-12 sm:py-16 border-b border-[var(--color-border-subtle)]">
        <div class="mx-auto max-w-6xl px-4 sm:px-6">
            <p class="text-xs font-semibold tracking-[0.2em] uppercase text-purple-600 mb-5 text-center">Welcome to {{ config('company.brand') }}</p>
            <div class="grid md:grid-cols-3 gap-4">
                <div class="rounded-2xl bg-white p-5 sm:p-6 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5 hover:border-purple-200">
                    ...
                    <h3 class="text-base font-bold text-[var(--color-text-main)] mb-2">Your Studio Awaits</h3>
                ...
                <div class="rounded-2xl bg-white p-5 sm:p-6 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5 hover:border-purple-200">
                    ...
                    <h3 class="text-base font-bold text-[var(--color-text-main)] mb-2">Pro Equipment & Setup</h3>
                    <p class="text-[var(--color-text-muted)] leading-relaxed">
                ...
                <div class="rounded-2xl bg-white p-5 sm:p-6 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5 hover:border-purple-200">
                    ...
                    <h3 class="text-base font-bold text-[var(--color-text-main)] mb-2">Ready for Any Project</h3>
                    <p class="text-[var(--color-text-muted)] leading-relaxed">
    ...
    <section id="features" class="bg-[var(--color-surface-muted)] py-12 sm:py-16">
        <div class="mx-auto max-w-6xl px-4 sm:px-6">
            <h2 class="text-2xl font-bold tracking-tight text-[var(--color-text-main)] sm:text-3xl mb-5">Podcast Studio for Rent in Delhi</h2>
            <div class="rounded-2xl bg-white p-6 sm:p-8 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] mb-6">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div class="flex items-center gap-2 rounded-xl bg-purple-50/50 border border-purple-100 p-3 transition-all duration-300 hover:bg-purple-50 hover:border-purple-200">
    ...
    <section class="bg-[var(--color-surface)] py-12 sm:py-16">
        <div class="mx-auto max-w-6xl px-4 sm:px-6">
            <h2 class="text-2xl font-bold tracking-tight text-[var(--color-text-main)] sm:text-3xl mb-5">Professional Podcast Equipment</h2>
            <p class="text-[var(--color-text-muted)] leading-relaxed mb-6 max-w-3xl">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="group rounded-2xl bg-white p-5 sm:p-6 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5 hover:border-purple-200">
                    <div class="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center mb-3 group-hover:bg-purple-600 transition-all duration-300">
    ...
    <section class="bg-[var(--color-surface-muted)] py-12 sm:py-16">
        <div class="mx-auto max-w-6xl px-4 sm:px-6">
            <h2 class="text-2xl font-bold tracking-tight text-[var(--color-text-main)] sm:text-3xl mb-5">Multi-Camera Video Podcast Setup</h2>
            <div class="rounded-2xl bg-white p-6 sm:p-8 shadow-lg shadow-slate-200/50 border border-[var(--color-border-subtle)] mb-6">
                ...
                <p class="text-[var(--color-text-muted)] font-medium mb-4">Our studio offers a multi-camera video podcast setup, allowing you to record:</p>
                <div class="grid sm:grid-cols-2 gap-3 mb-4">
                    ...
                    <div class="flex items-center gap-2 rounded-xl bg-purple-50/50 border border-purple-100 p-3 transition-all duration-300 hover:bg-purple-50 hover:border-purple-200">
                        <span class="flex-shrink-0 w-7 h-7 rounded-lg bg-purple-100 flex items-center justify-center">
                        ...
                        <span class="text-[var(--color-text-muted)] text-sm">{{ $item }}</span>
                    </div>
                    @endforeach
                </div>
                <p class="text-[var(--color-text-muted)] leading-relaxed">
    ...
    {{-- Location --}}
    <section class="border-t border-[var(--color-border-subtle)] bg-[var(--color-surface-muted)] py-12 sm:py-14">
        <div class="mx-auto max-w-6xl px-4 sm:px-6">
