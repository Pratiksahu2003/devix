<section class="relative bg-slate-950 py-24 text-white overflow-hidden">
    <div class="absolute inset-0">
        <img src="{{ asset('storage/dywix/IMG_4017.jpg') }}" alt="DyWix studio interior" class="h-full w-full object-cover" loading="lazy" decoding="async" width="1920" height="1080">
    </div>
